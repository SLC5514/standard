...
// 存储本地会话存储
export function setSession(session_name, data) {
  var a = this
  if (window.sessionStorage) {
...
// 删除本地会话存储
export function delSession(session_name) {
  var a = this
  if (window.sessionStorage) {
...
// 获取本地永久存储
export function getLocalSto(sto_name) {
  var a = this
...
// 存储本地永久存储
export function setLocalSto(sto_name, data) {
  var a = this
  if (window.localStorage) {
...
// 删除本地永久存储
export function delLocalSto(sto_name) {
  var a = this
  if (window.localStorage) {
